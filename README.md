# NXP legacy LPC target support for Mbed OS CE baremetal
...
## CLI
```
$ git clone --recursive https://github.com/toyowata/nxp-legacy-lpc-mbed-ce
$ cd nxp-legacy-lpc-mbed-ce
$ mkdir build && cd build
$ cmake .. -GNinja -DMBED_TARGET=AE_LPC11U35_MB
$ ninja
...
## Flash
```
sudo mount -u -w -o sync /Volumes/DAPLINK ; cp -X <path to firmware file> /Volumes/DAPLINK/
```
